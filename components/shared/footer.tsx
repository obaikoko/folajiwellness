      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-emerald-300 text-sm">
              Folaji Wellness is dedicated to providing natural, effective
              herbal solutions for your health and wellness needs.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a
                href="https://wa.me/2349133882941"
                target="_blank"
        ...
        <div className="border-t border-emerald-800 pt-8 text-center">
          <p className="text-emerald-400 text-sm">
            © {new Date().getFullYear()} Folaji Wellness. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
